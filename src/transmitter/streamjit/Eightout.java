...
public class Eightout implements Serializable {
	...
	public Eightout(boolean[] array0, boolean[] array1, boolean[] array2, boolean[] array3, boolean[] array4,
			boolean[] array5, boolean[] array6, boolean[] array7) {
		this.array0 = array0;
		this.array1 = array1;
		this.array2 = array2;
		this.array3 = array3;
	...
	public boolean[] getArray3() {
		return array3;
	}

	public boolean[] getArray4() {
		return array4;
	}

	public boolean[] getArray5() {
		return array5;
	}

	public boolean[] getArray6() {
		return array6;
	}

	public boolean[] getArray7() {
		return array7;
	}
}
