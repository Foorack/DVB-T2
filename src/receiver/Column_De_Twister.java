...
public class Column_De_Twister extends Pipeline<FEC_Frame, FEC_Frame> {

	@SuppressWarnings("unchecked")
	public Column_De_Twister() {
		// this.add(new Detwister());
		this.add(new Splitjoin<FEC_Frame, FEC_Frame>(new RoundrobinSplitter<FEC_Frame>(1),
				new RoundrobinJoiner<FEC_Frame>(1), new Detwister(), new Detwister()
	...
	private static class Detwister extends Filter<FEC_Frame, FEC_Frame> {
		...
		public void work() {
			...
			int T[] = { 0, 2, 2, 2, 2, 3, 7, 15, 16, 20, 22, 22, 27, 27, 28, 32 }; // Twisted
																					// parameter

			boolean[][] D_Buffer_1 = new boolean[R][C]; // Parameters for de
														// interleaving
