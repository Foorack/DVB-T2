...
public class FEC_Frame {
	 ...
	 * FEC_frame = new boolean[frameLength];
	 * 
	 * static final int Kbch = 48600; // LDPC + BCH = 64800 - 48600 // Kbch =
	 * DFL + Padding + 80
	 * 
	...
	final int DFL = Kbch - BBHeaderLength; // need padding of 48600-44600-80
											// bits
